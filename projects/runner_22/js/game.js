...
class Game {
    constructor() {
        ...
        this.splashScreen = {index: 0, timer: 100}
        this.fade = {reason: 1, value: 1, pause: 0}
    ...
    cycle() {
        ...
        if (this.splashScreen) {
            ...
            if (this.splashScreen.index > title[0].length + title[1].length + 5) {
                const start = (this.mobile ? "TAP" : "PRESS SPACE") + " TO START"
                ctx.fillStyle = "#888"
        ...
        ctx.strokeRect(innerWidth / 2 - 200, TEXT_SIZE, 400, TEXT_SIZE * 5)
        ctx.fillRect(innerWidth / 2 - 200, TEXT_SIZE, player.health * 400, TEXT_SIZE * 5)
